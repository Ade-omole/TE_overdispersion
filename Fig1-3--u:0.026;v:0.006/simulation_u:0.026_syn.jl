...
L = 1000  ## Length of each haploid chromosome (loci)
...
function generate_next_generation(gen)
    ...
    csv_file_path = "path/s:$(s)_N:$(population_size)_r:$(r)_beta:$(u)_delta:$(v)_syn___.csv"
...
@time begin
    ...
    println("  Fitness function: 1 - s * x_total^2  # synergistic fitness")
