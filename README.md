...
Empirical data source: [Lee et al. (2022)](https://doi.org/10.1093/gbe/evac016), DPGP3 TE insertion matrix ([raw data](https://github.com/jumpingTE-LeeLab/TE_insertion_DPGP3_raw)).

Theory comparison: [Roze (2023)](https://doi.org/10.1093/gbe/evad123).
